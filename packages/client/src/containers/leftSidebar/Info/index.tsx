...
function test(index: React.SetStateAction<any>) {
  ...
  return (
    ...
    <div className={styles.wrap}>
      ...
      {/* <div className={styles.main}> */}
      {/*   <div className={styles.question}>How can I close my account?</div> */}
      {/*   <div><FontIcon name={FontIconName.SolidArrow} size={12} /></div> */}
      {/* </div> */}
      {/* <div className={styles.answer}> */}
      {/*   When you sigh in to the site or app, you can click the “Forgot your password?” link and enter the email address you used for registration. You will get an email message with link for setting a new password */}
      {/* </div> */}
    </div>
  );
};
