...
const Signals: FC<Props> = ({
 ...
 const graphic = <svg width="80" height="25" viewBox="0 0 80 25" fill="none" xmlns="http://www.w3.org/2000/svg">
   <path opacity="1" d="M60.2898 15.6345H65.3358L79.2122 8.934L79.2122 24.3896H0L8.8212 7.7551L14.3717 2.69334L20.4269 0H27.4912L34.3032 2.69334L40.6107 0L54.487 6.04358L60.2898 15.6345Z" fill="url(#paint0_linear_1893_1035)"/>
   <defs>
     <linearGradient id="paint0_linear_1893_1035" x1="47.8596" y1="16.3749" x2="47.8596" y2="28" gradientUnits="userSpaceOnUse">
  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.descrtiprion}>Latest technical overviews and analysis of your selected instruments, based on recent
