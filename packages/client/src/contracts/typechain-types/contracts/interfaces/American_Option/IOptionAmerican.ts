...
export interface IOptionAmericanInterface extends utils.Interface {
  functions: {
...
export interface IOptionAmerican extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOptionAmericanInterface;
  ...
  functions: {
    ...
    bet_close(
      bet_id: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
