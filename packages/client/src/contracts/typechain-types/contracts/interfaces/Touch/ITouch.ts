...
export interface ITouchInterface extends utils.Interface {
  functions: {
...
export interface ITouch extends BaseContract {
  ...
  functions: {
    ...
    calculateOptionPrice(
      ...
      [BigNumber, BigNumber] & { iOptionPrice: BigNumber; hv: BigNumber }
    >;
