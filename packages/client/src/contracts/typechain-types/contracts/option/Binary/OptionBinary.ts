...
export interface OptionBinaryInterface extends utils.Interface {
  functions: {
    ...
    "_bet_close(uint256,uint256)": FunctionFragment;
    ...
    "calculateOptionPrice(uint256,uint256,uint256)": FunctionFragment;
...
export interface OptionBinary extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptionBinaryInterface;
  ...
  functions: {
    ...
    _bet_close(
      ...
      closePrice: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
