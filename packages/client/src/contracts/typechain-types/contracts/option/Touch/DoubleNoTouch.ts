...
export interface DoubleNoTouchInterface extends utils.Interface {
  functions: {
    "DECIMALS()": FunctionFragment;
    "MAX_DURATION()": FunctionFragment;
    "MIN_DURATION()": FunctionFragment;
    "_bet_add(address,uint256,uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
    "_bet_close(uint256,uint256,uint256)": FunctionFragment;
    "addTrustedAddress(address)": FunctionFragment;
    "bet()": FunctionFragment;
    "bet_add(uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
    ...
    "calculateOptionPrice(uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
...
export interface DoubleNoTouch extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DoubleNoTouchInterface;
  ...
  functions: {
    ...
    _bet_add(
      ...
      lowerBarrier: PromiseOrValue<BigNumberish>,
      upperBarrier: PromiseOrValue<BigNumberish>,
